...
$_SYSTEM['lang'] = array(
    ...
    'Uploaded files size greater then "%s"' => 'Загружаемый объем файла(ов) больше допустимого: "%s"',
    ...
    'Invalid callable for exec method'  => 'Не верная функция callback для exec метода',
